      ...
      <div className="container mx-auto flex flex-wrap justify-between items-center">
        ...
        <div className="flex space-x-4 mt-4 sm:mt-0">
          {/* <button
            ...
            className={`flex items-center space-x-2 px-4 py-2 rounded-full transition-colors duration-200 ease-in-out ${activeSection === 'explore' ? 'bg-indigo-500 text-white shadow-md' : 'text-gray-600 hover:bg-gray-100 hover:text-indigo-600'}`}
          >
          ...
          <button
            ...
            className={`flex items-center space-x-2 px-4 py-2 rounded-full transition-colors duration-200 ease-in-out ${activeSection === 'favorites' ? 'bg-indigo-500 text-white shadow-md' : 'text-gray-600 hover:bg-gray-100 hover:text-indigo-600'}`}
          >
            <LucideStar size={18} />
          ...
          <button
            ...
            className={`flex items-center space-x-2 px-4 py-2 rounded-full transition-colors duration-200 ease-in-out ${activeSection === 'leaderboard' ? 'bg-indigo-500 text-white shadow-md' : 'text-gray-600 hover:bg-gray-100 hover:text-indigo-600'}`}
          >
