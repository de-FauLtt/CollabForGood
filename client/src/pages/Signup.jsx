...
//     console.log({ ngoName, ngoEmail, ngoPassword, orgType, ngoLocation, ngoPhoneNumber });
//   };

//   const handleDonorSubmit = (e) => {
//     e.preventDefault();
//     // Handle Donor sign-up logic here
//     console.log({ donorName, donorEmail, donorPassword });
//   };

//   return (
//     <div className="bg-gray-50 min-h-screen font-sans antialiased text-gray-900 flex items-center justify-center p-4 sm:p-8">
//       <div className="bg-white rounded-3xl shadow-2xl p-8 sm:p-12 w-full max-w-5xl flex flex-col md:flex-row">
//         {/* Left Section: Quotes */}
...
//               className={`flex-1 py-3 px-6 rounded-full font-bold text-sm sm:text-base transition-colors duration-200 ${isNgo ? 'bg-pink-600 text-white shadow' : 'text-gray-600 hover:bg-gray-200'}`}
//             >
...
//               className={`flex-1 py-3 px-6 rounded-full font-bold text-sm sm:text-base transition-colors duration-200 ${!isNgo ? 'bg-fuchsia-500 text-white shadow' : 'text-gray-600 hover:bg-gray-200'}`}
//             >
//               <div className="flex items-center justify-center space-x-2">
//                 <LucideUser size={20} />
//                 <span>Donor</span>
...
//                   className="w-full pl-12 pr-4 py-4 rounded-full border-2 border-gray-200 focus:outline-none focus:ring-2 focus:ring-pink-500 transition-colors duration-200"
//                   required
//                 />
//               </div>
//               <div className="relative">
...
//                   className="w-full pl-12 pr-10 py-4 rounded-full border-2 border-gray-200 appearance-none focus:outline-none focus:ring-2 focus:ring-pink-500 transition-colors duration-200 text-gray-600"
//                   required
//                 >
...
//                 />
//               </div>
//               <button type="submit" className="w-full py-4 px-6 bg-pink-600 text-white font-bold rounded-full text-lg hover:bg-pink-700 transition-colors duration-200 shadow-md">
//                 Register NGO
//               </button>
//             </form>
//           ) : (
...
//                   className="w-full pl-12 pr-4 py-4 rounded-full border-2 border-gray-200 focus:outline-none focus:ring-2 focus:ring-fuchsia-500 transition-colors duration-200"
//                   required
//                 />
//               </div>
//               <div className="relative">
...
//                 />
//               </div>
//               <button type="submit" className="w-full py-4 px-6 bg-fuchsia-500 text-white font-bold rounded-full text-lg hover:bg-fuchsia-600 transition-colors duration-200 shadow-md">
//                 Create Donor Account
//               </button>
//             </form>
//           )}
//           <p className="mt-8 text-gray-600">
//             Already have an account? <a href="#" className={isNgo ? "text-pink-600 font-semibold hover:underline" : "text-fuchsia-500 font-semibold hover:underline"}>Log in here</a>
//           </p>
//         </div>
//       </div>
//     </div>
    ...
    <div className="bg-[#e4e4e7] min-h-screen w-screen font-sans antialiased text-gray-900 flex items-center justify-center p-4 sm:p-8">
      <div className="bg-white rounded-3xl shadow-2xl p-8 sm:p-12 w-full max-w-7xl flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 p-4 md:p-8 mt-8 md:mt-0 flex flex-col justify-center">
          ...
          <p className="mt-8 text-gray-600">
            Already have an account? <a href="#" className={isNgo ? linkNgoColor + ' font-semibold hover:underline' : linkDonorColor + ' font-semibold hover:underline'}>Log in here</a>
          </p>
        </div>
      </div>
    </div>
