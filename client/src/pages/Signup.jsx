...
export default function App() {
  ...
  return (
    <div className="bg-[#e4e4e7] min-h-screen w-screen font-sans antialiased text-gray-900 flex items-center justify-center p-4 sm:p-8">
      <div className="bg-white rounded-3xl shadow-2xl p-2 sm:p-12 w-full max-w-7xl flex flex-col md:flex-row">
        
        {/* Left Section: Quotes and Info */}
        
        <div className="flex flex-col items-center justify-center pr-4 pb-4 pl-4 md:p-8 md:w-1/2 text-center md:text-left">
        {/* Heading */}
        <h1 className="text-3xl font-bold text-center text-black-600  pr-4 pb-4 pl-4 mb-6">
          Collab4Good
        </h1>
          {/* <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 40 40" className="mb-4">
            <circle cx="20" cy="20" r="20" fill={logoFillColor} />
          ...
          <img 
            src={"/image2.jpg"}   // put your logo file inside public folder as /public/logo.png
            alt="Collab-For-Good Logo"
            className="h-40 w-auto mb-12 mx-auto rounded-full object-cover shadow-md "
          />
          {/* <img 
            src="/logo.png"   // place logo.png inside /public folder
            alt="Collab-For-Good Logo"
            className="h-24 w-24 mb-4 mx-auto rounded-full object-cover shadow-md border-2 border-indigo-500"
          /> */}
          <div className="text-3xl text-center text-gray-800 leading-snug font-bold">
            We believe that by fostering a community of collaboration and resource sharing, we can help these organizations achieve their goals more efficiently and effectively.
          </div>
          <p className="text-gray-600 mt-4 text-xl">
            - The Collab for Good Team
